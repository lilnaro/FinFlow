...
fun ArchiveScreen(
    ...
    Scaffold(
        ...
        containerColor = ArchiveColors.Background,
    ) { innerPadding ->
        ...
        Column(
            ...
            Text(
                text = "Архив месяцев",
                color = ArchiveColors.PrimaryText,
                fontSize = 28.sp,
            ...
            Text(
                text = "Здесь будут храниться данные о завершённых финансовых месяцах",
                color = ArchiveColors.SecondaryText,
                fontSize = 16.sp,
                textAlign = TextAlign.Center,
            )
            ...
            OutlinedButton(
                ...
                border = BorderStroke(
                    width = 1.dp,
                    color = ArchiveColors.Border,
                ),
                colors = ButtonDefaults.outlinedButtonColors(
                    containerColor = Color.Transparent,
                    contentColor = ArchiveColors.PrimaryText,
                ),
            ) {
                Text(
                    text = "Назад",
